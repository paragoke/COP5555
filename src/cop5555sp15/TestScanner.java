...
public class TestScanner {
	...
	@Test
	public void dotsAndRanges() {				/* DOUBT */
	...
	@Test
	public void compareTokenList() {					/* Token beg end doubtful */
	...
	@Test
	public void identifiers() {									/* Complicated EDGE case*/
	...
	@Test
	public void test11(){						/* String and comments interlaced */
		System.out.println("String and comments interlaced");
		
		String input1 = "/* \" String \" */";
		String input2 = "\" /* ** */\"";
		
		TokenStream stream = new TokenStream(input1);
		Scanner scanner = new Scanner(stream);
		scanner.scan();
		assertEquals(1, stream.tokens.size());
		
		TokenStream stream2 = new TokenStream(input2);
		Scanner scanner2 = new Scanner(stream2);
		scanner2.scan();
		assertEquals(2, stream2.tokens.size());
	}
	
	
	@Test
	public void test12(){
		System.out.println("Input : abc_1");
		String input = "abc_1";
		TokenStream ts = new TokenStream(input);
		Scanner sc = new Scanner(ts);
		sc.scan();
		System.out.println(ts.tokens.toString());
	}
